...
from common import generate_image, generate_images,num_range, zs_to_ws, line_interpolate
    ...
    if(args.vid):
        ...
        for l in latents:
            ...
            for j in index_list_of_eigenvalues:
                ...
                fcount = 0
                for pt in pts:
                    img = generate_image(G, pt, label, truncation_psi, noise_mode, args.space)
                    grid = utils.save_image(
                        img,
